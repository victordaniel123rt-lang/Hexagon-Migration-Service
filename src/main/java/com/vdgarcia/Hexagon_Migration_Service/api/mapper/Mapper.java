...
public class Mapper {
    ...
    public static PedidoDTO toPedidoDTO(Pedido pedido){
        ...
        List<DetallePedidoDTO> detalles = pedido.getDetalles().stream().map(Mapper::toDetallePedidoDTO).toList();
    ...
    public static ProductoDTO toProductoDTO(Producto producto){
        ...
        List<DetallePedidoDTO> detalles = producto.getDetalles().stream().map(Mapper::toDetallePedidoDTO).toList();
